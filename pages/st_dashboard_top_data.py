...
from utilities_data import get_initial_data, get_top_directors, get_top_genres, get_top_actors, get_merged_genres, get_merged_actors, get_merged_directors, get_merged_years, get_average_score
